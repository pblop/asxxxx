...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS6100\i6100.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\i61adr.OBJ  \
		 $(OUTPUTDIR)\i61mch.OBJ  $(OUTPUTDIR)\i61pst.OBJ 
...
$(OUTPUTDIR)\i61adr.OBJ:	..\..\..\AS6100\i61adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i61adr.obj ..\..\..\AS6100\i61adr.c



$(OUTPUTDIR)\i61mch.OBJ:	..\..\..\AS6100\i61mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i61mch.obj ..\..\..\AS6100\i61mch.c



$(OUTPUTDIR)\i61pst.OBJ:	..\..\..\AS6100\i61pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i61pst.obj ..\..\..\AS6100\i61pst.c
