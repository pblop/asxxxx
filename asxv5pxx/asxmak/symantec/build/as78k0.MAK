...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS78K0\r78k0.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\r78k0adr.OBJ  \
		 $(OUTPUTDIR)\r78k0mch.OBJ  $(OUTPUTDIR)\r78k0pst.OBJ 
...
$(OUTPUTDIR)\r78k0adr.OBJ:	..\..\..\AS78K0\r78k0adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\r78k0adr.obj ..\..\..\AS78K0\r78k0adr.c



$(OUTPUTDIR)\r78k0mch.OBJ:	..\..\..\AS78K0\r78k0mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\r78k0mch.obj ..\..\..\AS78K0\r78k0mch.c



$(OUTPUTDIR)\r78k0pst.OBJ:	..\..\..\AS78K0\r78k0pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\r78k0pst.obj ..\..\..\AS78K0\r78k0pst.c
