...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS8X300\s8x.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\s8xadr.OBJ  \
		 $(OUTPUTDIR)\s8xmch.OBJ  $(OUTPUTDIR)\s8xpst.OBJ 
...
$(OUTPUTDIR)\s8xadr.OBJ:	..\..\..\AS8X300\s8xadr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s8xadr.obj ..\..\..\AS8X300\s8xadr.c



$(OUTPUTDIR)\s8xmch.OBJ:	..\..\..\AS8X300\s8xmch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s8xmch.obj ..\..\..\AS8X300\s8xmch.c



$(OUTPUTDIR)\s8xpst.OBJ:	..\..\..\AS8X300\s8xpst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\s8xpst.obj ..\..\..\AS8X300\s8xpst.c
