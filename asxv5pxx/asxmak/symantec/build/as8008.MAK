...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS8008\i08.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\i08adr.OBJ  \
		 $(OUTPUTDIR)\i08mch.OBJ  $(OUTPUTDIR)\i08pst.OBJ 
...
$(OUTPUTDIR)\i08adr.OBJ:	..\..\..\AS8008\i08adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i08adr.obj ..\..\..\AS8008\i08adr.c



$(OUTPUTDIR)\i08mch.OBJ:	..\..\..\AS8008\i08mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i08mch.obj ..\..\..\AS8008\i08mch.c



$(OUTPUTDIR)\i08pst.OBJ:	..\..\..\AS8008\i08pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i08pst.obj ..\..\..\AS8008\i08pst.c
