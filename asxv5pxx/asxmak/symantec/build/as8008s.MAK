...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS8008S\i08s.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\i08sadr.OBJ  \
		 $(OUTPUTDIR)\i08smch.OBJ  $(OUTPUTDIR)\i08spst.OBJ 
...
$(OUTPUTDIR)\i08sadr.OBJ:	..\..\..\AS8008S\i08sadr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i08sadr.obj ..\..\..\AS8008S\i08sadr.c



$(OUTPUTDIR)\i08smch.OBJ:	..\..\..\AS8008S\i08smch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i08smch.obj ..\..\..\AS8008S\i08smch.c



$(OUTPUTDIR)\i08spst.OBJ:	..\..\..\AS8008S\i08spst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i08spst.obj ..\..\..\AS8008S\i08spst.c
